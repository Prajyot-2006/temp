public class privateAM04 {

    private static class Pokemon {  // this private class is only accesible inside the privateAM04 class , we can even access it via psvm ,coz psvm is inside privateAM04 class
    ...
    // System.out.println(pikachu.power); -- u cannot write statement inside class , this statement is written directly in privateAM04 class
}
